    ...
    <div class="row-2">
       	<div class="main">
            	<div class="container_12">
                	...
                	<div class="grid_9">
                    	<h1>
                            <a class="logo" href="home.php">Jillani</a>
                            <span>Event Organizers</span>
                        </h1>
                       
                    </div>
                    <div class="grid_3">
                    	<form id="search-form" method="post" enctype="multipart/form-data"> <img src="images/cooltext1148775572.png" width="298" height="46">
...
<footer>
  ...
  <div class="wrapper">
                	<div class="grid_4">
                        ...
                        <div><a rel="nofollow" target="_blank" hrfhome.php">Jillani Events Organizers</a> by Rashid Channer|</div>
                        <!-- {%FOOTER_LINK} -->
                    </div>
                    <div class="grid_4">
                    	<span class="phone-numb"><span>+(92)</span> 303-9306991</span>
                    </div>
                    <div class="grid_4">
